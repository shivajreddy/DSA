...
class TestTour(unittest.TestCase):
    tsp_2 = read_point_file('test_data/tsp2.txt')
    tsp_3 = read_point_file('test_data/tsp3.txt')
    tsp_10 = read_point_file('test_data/tsp10.txt')
    tsp_100 = read_point_file('test_data/tsp100.txt')
    tsp_1000 = read_point_file('test_data/tsp1000.txt')
