...
class GraphTest(unittest.TestCase):
    ...
    '''
    Probability review: Just because there are 2 different possibilities does not 
    ...
    Here, a->c->d->treasure has a 50% chance of happening, a->b->e is 25%, and a->b->d->treasure is 25%. 
    ...
    def test_probability_player_will_make_it(self):
        ...
        dungeon = self.create_dungeon7()
        self.assertEqual(dungeon.probability_player_will_make_it(Player(100)), 0.375)
